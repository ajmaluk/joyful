...
export function ThinkingBubble({ isRateLimited = false }: ThinkingBubbleProps) {
    ...
    <div className="mr-20 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      >
        <span
          ...
          style={isRateLimited ? { animationName: 'wave-bounce', backgroundColor: 'var(--ring)' } : undefined}
        ></span>
        <span
          className="thinking-wave-dot"
          style={isRateLimited ? { animationName: 'wave-bounce', backgroundColor: 'var(--ring)' } : undefined}
