...
export function AnimatedDemo() {
  ...
  return (
    <section ref={ref} className="relative isolate flex min-h-screen items-center overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
      ...
      <motion.div
        aria-hidden="true"
        className="absolute left-1/2 top-1/2 -z-10 h-[34rem] w-[34rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(99,135,255,0.22),rgba(240,150,220,0.14)_42%,transparent_70%)] blur-3xl dark:bg-[radial-gradient(circle,rgba(99,135,255,0.18),rgba(240,150,220,0.12)_42%,transparent_70%)]"
      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <motion.div
          ...
          className="mt-12 overflow-hidden rounded-2xl border border-gray-200 bg-white/92 shadow-2xl shadow-indigo-950/10 backdrop-blur-xl dark:border-white/10 dark:bg-[#1a1b19]/95 dark:shadow-black/40"
        >
          {/* Window chrome */}
          ...
          <div className="grid min-h-[420px] lg:grid-cols-[240px_1fr_260px]">
            {/* Mini chat panel */}
            ...
            {/* Mini preview */}
            <div className="relative flex items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#f8faff,#f5f0ff_48%,#fff7f2)] p-6 dark:bg-[linear-gradient(135deg,#161714,#202238_48%,#241822)]">
              <motion.div
                className="absolute inset-x-8 top-8 h-24 rounded-full bg-[linear-gradient(90deg,rgba(47,91,255,0.18),rgba(242,60,120,0.12),rgba(255,113,58,0.12))] blur-3xl"
              ...
              >
                ...
                <div className="space-y-3 p-5">
                  {/* Mock hero */}
                  <motion.div
                    className="h-5 rounded bg-gradient-to-r from-[#2f5bff]/24 via-[#a78bfa]/24 to-[#f23c78]/24"
                  ...
                  />
                  <motion.div
                    className="h-8 rounded-full bg-[#2f5bff]/15"
                  ...
                  <div className="mt-3 grid grid-cols-3 gap-2">
                    {[0, 1, 2].map((card) => (
                      <motion.div
                        key={card}
                        className="h-14 rounded bg-gray-100 dark:bg-white/5"
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-2">
                    {[0, 1].map((card) => (
                      <motion.div
                        key={card}
                        className={`h-16 rounded ${card === 1 ? 'border-2 border-[#2f5bff]/30' : 'border border-gray-200 dark:border-white/10'}`}
