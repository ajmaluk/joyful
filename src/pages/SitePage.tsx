    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#e8ecff_20%,#d4dcff_38%,#f0e0ff_56%,#ffe0ec_72%,#fff0e0_100%)] text-gray-950 dark:bg-[linear-gradient(180deg,#0a0a0a_0%,#161719_20%,#21365f_38%,#3a2040_56%,#4a1030_72%,#4a2010_100%)] dark:text-[#f6f2ea]">
        ...
        <motion.div {...revealUp} transition={{ duration: 0.5 }} className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold tracking-normal text-gray-950 dark:text-white">Keep the {page.badge.toLowerCase()} story connected.</h2>
            </div>
      ...
      <section className="relative isolate min-h-screen overflow-hidden">
        ...
        >
          ...
          <h2 className="max-w-5xl text-balance text-5xl font-bold leading-[1.02] tracking-normal text-gray-950 sm:text-6xl lg:text-7xl dark:text-white">Keep building from here</h2>
          <p className="mt-5 max-w-2xl text-lg font-medium leading-8 text-gray-700 dark:text-white/70">
