...
export function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#e8ecff_20%,#d4dcff_38%,#f0e0ff_56%,#ffe0ec_72%,#fff0e0_100%)] text-gray-950 dark:bg-[linear-gradient(180deg,#0a0a0a_0%,#161719_20%,#21365f_38%,#3a2040_56%,#4a1030_72%,#4a2010_100%)] dark:text-[#f6f2ea]">
      <section className="relative isolate min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-4 py-24 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-5 max-w-3xl text-lg font-medium leading-8 text-gray-600 sm:text-xl dark:text-white/70">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white/70 px-5 py-3 text-sm font-semibold text-gray-800 backdrop-blur transition-colors hover:bg-white dark:border-white/10 dark:bg-white/10 dark:text-white dark:hover:bg-white/15"
              >
                Browse templates
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              ...
              <motion.div
                ...
                className="rounded-lg border border-gray-200 bg-white/75 p-5 shadow-xl shadow-indigo-950/5 backdrop-blur transition-transform duration-300 hover:-translate-y-1 dark:border-white/10 dark:bg-black/20"
              >
      ...
      <section className="border-y border-gray-200/60 bg-white/60 px-4 py-16 backdrop-blur-sm sm:px-6 lg:px-8 dark:border-white/8 dark:bg-[#171816]/60">
        <motion.div {...revealUp} transition={{ duration: 0.5 }} className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h2 className="text-4xl font-bold tracking-normal text-gray-950 dark:text-white">Free workspace essentials</h2>
            ...
            {included.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group rounded-xl border border-gray-200 bg-gray-50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#2f5bff]/30 hover:bg-white hover:shadow-xl dark:border-white/8 dark:bg-[#21221f] dark:hover:border-white/18 dark:hover:bg-[#252622] dark:hover:shadow-[0_8px_30px_rgba(0,0,0,0.3)]"
                >
      ...
      <section className="px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_1.05fr] lg:items-center">
          <motion.div {...revealUp} transition={{ duration: 0.5 }}>
            <p className="text-sm font-semibold uppercase tracking-normal text-indigo-600 dark:text-[#8fa7ff]">Why it stays simple</p>
          ...
          >
            <div className="grid gap-4">
              <div className="rounded-md bg-white p-5 dark:bg-[#181916]">
                <div className="flex items-center gap-3 border-b border-gray-200 pb-5 dark:border-white/8">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#2f5bff] to-[#f23c78] text-white">
                    <Sparkles className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-gray-950 dark:text-white">Free Workspace</h3>
                    <p className="text-sm text-gray-600 dark:text-[#aaa69d]">Everything you need to build and export</p>
                  </div>
                </div>
                <div className="mt-6 flex items-baseline gap-2">
                  <span className="text-6xl font-bold text-gray-950 dark:text-white">$0</span>
                  <span className="text-lg font-semibold text-gray-600 dark:text-[#aaa69d]">/ forever</span>
                </div>
                <div className="mt-7 grid gap-3 sm:grid-cols-2">
                  {features.map((feature) => (
                    <div key={feature} className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700 dark:border-white/8 dark:bg-white/[0.03] dark:text-[#d6d1c7]">
        ...
        <motion.div {...revealUp} transition={{ duration: 0.5 }} className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold tracking-normal text-gray-950 dark:text-white">Keep the pricing story connected.</h2>
            </div>
      ...
      <section className="relative isolate min-h-screen overflow-hidden">
        ...
        >
          ...
          <h2 className="max-w-5xl text-balance text-5xl font-bold leading-[1.02] tracking-normal text-gray-950 sm:text-6xl lg:text-7xl dark:text-white">Build without a pricing wall</h2>
          <p className="mt-5 max-w-2xl text-lg font-medium leading-8 text-gray-700 sm:text-xl dark:text-white/70">
            Open the workspace, start from a prompt, and export when the page is ready.
          </p>
          <button
            type="button"
            onClick={() => navigate('/builder')}
            className="mt-10 inline-flex items-center justify-center gap-2 rounded-xl bg-gray-950 px-6 py-3 text-sm font-bold text-white shadow-xl shadow-indigo-950/10 transition-transform hover:scale-[1.02] dark:bg-white dark:text-[#171816]"
          >
            Open workspace
            <ArrowRight className="h-4 w-4" />
          </button>
